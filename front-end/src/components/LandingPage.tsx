    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="bg-black p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            <Link to="/login" className="px-4 py-2 text-white hover:text-[#049981] transition">Login</Link>
            <Link to="/register" className="px-4 py-2 text-white hover:text-gray-800 bg-[#049981] hover:bg-[#038371] rounded-md transition">Register</Link>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="flex flex-col md:flex-row items-center">
          <div className="p-6 md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex space-x-4">
              <Link
                to="/register"
                className="px-6 py-3 bg-[#049981] hover:bg-[#038371] hover:text-gray-800 text-white rounded-md font-medium transition"
              >
                Get Started
              </Link>
              <Link
                to="/login"
                className="px-6 py-3 border border-white hover:bg-gray-800 text-white rounded-md font-medium transition"
              >
                Log In
              </Link>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
              <div className="mb-4">
                ...
                <div className="flex justify-between items-center mb-2">
                  <div>TOTAL VALUE</div>
                  <div className="text-[#049981] text-xl font-bold">$600.00</div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="text-[#049981] text-4xl mb-4">
